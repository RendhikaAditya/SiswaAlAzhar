...
import com.example.siswaal_azhar.databinding.ActivityJadwalUjianBinding;
...
public class JadwalUjianActivity extends AppCompatActivity {
    private ActivityJadwalUjianBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityJadwalUjianBinding.inflate(getLayoutInflater());
    ...
    private void getJadwal(String day) {
        ...
        AndroidNetworking.post(ApiServer.site_url+"get_jadwal_ujian.php")
